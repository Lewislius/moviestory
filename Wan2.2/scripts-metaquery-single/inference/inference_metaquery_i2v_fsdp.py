"""
Determined/torchrun friendly FSDP inference entry for MetaQuery + Wan I2V.
"""
...
import inference_metaquery_i2v as base
...
class MetaQueryI2VPipelineFSDP(base.MetaQueryI2VPipeline):
    ...
    def _load_pipeline(self):
        ...
        if self._dist_env.rank == 0:
            print(
                f"[FSDP] I2V loaded | rank={self._dist_env.rank} "
...
def main():
    ...
    try:
        ...
        pipeline = MetaQueryI2VPipelineFSDP(args, env)
        ...
        print(
            ...
            f"steps={args.sampling_steps} max_area={args.max_area}",
            flush=True,
        )
