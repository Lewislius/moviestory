...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/home/liuzhirui/model/Wan2.2/checkpoint/metaquery_overfit10_ti2v_firstframe_wan_cond/ti2v_firstframe_wancond_overfit10_steps800_nummq256_nullimg0.1_nullcap0.1/checkpoint-final}"
...
GUIDE_SCALE_LOW="${GUIDE_SCALE_LOW:-7.5}"
GUIDE_SCALE_HIGH="${GUIDE_SCALE_HIGH:-7.5}"
