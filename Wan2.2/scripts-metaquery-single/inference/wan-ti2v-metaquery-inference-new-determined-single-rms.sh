...
# Required paths
# -----------------------------
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/home/liuzhirui/model/Wan2.2/checkpoint/metaquery_overfit20_cond_only/ti2v_overfit30_steps804_nummq256_nullimg0.1_nullcap0.1/checkpoint-final}"
...
VERIFY_FAIL_ON_WARNING="${VERIFY_FAIL_ON_WARNING:-1}" # 1 => warning 直接失败（默认开启，避免静默错配）
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/outputs_step600_20260331}"
mkdir -p "${OUTPUT_DIR}"
