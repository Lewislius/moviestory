...
DIT_FSDP="${DIT_FSDP:-1}"
T5_FSDP="${T5_FSDP:-0}"
# 48G 卡建议默认打开 SP，切分序列激活显存
USE_SP="${USE_SP:-1}"
# 48G 卡建议默认把 T5 放 CPU，释放显存给 DiT 去噪
T5_CPU="${T5_CPU:-1}"
...
PROMPT="${PROMPT:-A person dancing on a stage with smooth camera motion.}"
NEG_PROMPT="${NEG_PROMPT:-}"
REF_IMAGE="${REF_IMAGE:-/home/liuzhirui/dataset/demo/ref.png}"
...
ANIMATE_STEPS="${ANIMATE_STEPS:-30}"
