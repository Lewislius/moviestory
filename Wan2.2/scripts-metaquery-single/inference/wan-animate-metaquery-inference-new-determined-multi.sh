...
TI2V_FRAME_NUM="${TI2V_FRAME_NUM:-77}"
TI2V_SIZE_W="${TI2V_SIZE_W:-1280}"
TI2V_SIZE_H="${TI2V_SIZE_H:-720}"
TI2V_MAX_AREA="${TI2V_MAX_AREA:-921600}"
TI2V_STEPS="${TI2V_STEPS:-50}"
TI2V_GUIDE_SCALE="${TI2V_GUIDE_SCALE:-5.0}"
TI2V_SHIFT="${TI2V_SHIFT:-5.0}"

I2V_FRAME_NUM="${I2V_FRAME_NUM:-77}"
