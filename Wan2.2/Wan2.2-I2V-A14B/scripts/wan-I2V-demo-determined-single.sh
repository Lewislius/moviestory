#!/bin/bash
# Batch generation script for I2V-A14B (Single GPU with offload)
# This script processes all example folders (001-010) and generates videos using single GPU with model offloading
...
START_FOLDER="001"
END_FOLDER="005"
CHECKPOINT_DIR="/home/liuzhirui/model/Wan2.2/Wan2.2-I2V-A14B"
EXAMPLES_DIR="/home/liuzhirui/model/Wan2.2/Wan2.2-I2V-A14B/examples"
OUTPUTS_DIR="/home/liuzhirui/model/Wan2.2/Wan2.2-I2V-A14B/outputs"
SIZE="1280*720"
GPU_ID=""
...
# Memory optimization settings for single GPU
...
echo "========================================"
echo "Starting batch I2V-A14B generation (Single GPU with offload)"
...
for i in $(seq $start_num $end_num); do
    ...
    # Run the generation command (single GPU with offload)
    echo "[$folder_name] Starting single-GPU generation with model offloading..."
    start_time=$(date +%s)
...
echo ""
echo "========================================"
echo "Batch I2V-A14B generation completed!"
echo "========================================"
